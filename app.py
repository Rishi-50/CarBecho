...
df = pickle.load(open('D:\Hackathon\Data Hack\DATAGEEKS_Datahack-main\df.pkl','rb'))
pipe = pickle.load(open('D:\Hackathon\Data Hack\DATAGEEKS_Datahack-main\pipe.pkl','rb'))
